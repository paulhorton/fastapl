...
say  "\n$0 Running fastapl5...";
system  "t/fastaqplRegressionTester.pl @ARGV fastapl5 t/regression/oneLinerLists/fastapl5oneLiners.txt"
    and   exit 1;    #Exit if error encountered.


say  "\n$0 Running fastqpl5...";
system  "t/fastaqplRegressionTester.pl @ARGV fastqpl5 t/regression/oneLinerLists/fastqpl5oneLiners.txt";
